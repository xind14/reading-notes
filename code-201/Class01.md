...
Lab Assignment Submitted: [Link to the Private Gist](https://gist.github.com/xind14/2c157657c52d619cd08ca3947a90ed7c)
...
- `Semantic HTML`: HTML you write thoughtfully, picking tags that always indicate the type of content within
- Right click, inspect, use `Lighthouse`: analyzes accessibility. Gives you a report grade.

```
In-class demo for lab:
